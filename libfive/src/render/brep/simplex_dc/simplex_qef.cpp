...
typename SimplexQEF<N>::Vector SimplexQEF<N>::solveRaw() const
{
    ...
    for (unsigned i = 0; i < N; ++i) {
        ...
        // need much of an eigenvalue cutoff.  We could still have problems if
        // floating-point error in the SelfAdjointEigenSolver increases the
        // effective rank of our AtA matrix, though, so we do need a small
        // cutoff to handle that.
